<%-- 
    Document   : genelTalepYeni
    Created on : 29.Şub.2012, 23:02:31
    Author     : caner
--%>
...
<script type="text/javascript" src="static/js/kisiselTalep/digerEdit.js"></script>
<link rel="stylesheet" type="text/css" href="static/css/kisiselTalep/generalForms.css"/>

<input class="digerDivHeight" name="digerDivHeight" value="${digerDivHeight}"/>
<p class="general_form_headers">DIGER TALEPLER</p>

<form:form id="talepDigerYeni" modelAttribute="editYapilanIslem"  method="POST" action="digerEdit/talepEklendi/yeni">
