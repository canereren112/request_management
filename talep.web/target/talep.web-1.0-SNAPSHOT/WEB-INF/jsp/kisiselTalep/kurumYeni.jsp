<%-- 
    Document   : kurumYeni
    Created on : 29.Şub.2012, 03:20:20
    Author     : caner
--%>
...
<script type="text/javascript" src="static/js/kisiselTalep/kurumEdit.js"></script>
<link rel="stylesheet" type="text/css" href="static/css/kisiselTalep/generalForms.css"/>

<input class="kurumDivHeight" name="kurumDivHeight" value="${kurumDivHeight}"/>
<p class="general_form_headers">KURUM TALEBI</p>

<form:form id="talepKurumYeni" modelAttribute="editYapilanIslem"  method="POST" action="kurumEdit/talepEklendi/yeni">
    ...
    <div class="talep_sahibi_div aristo_light_background">
        ...
        <div class="talep_sahibi_evrak_tarih_sayisi kayit_text">
            Evrak Tarihi ve Sayisi : <form:input type="text" class="talep_sahibi_evrak_tarih_sayisi_input" path="genelTalep.talepSahibi.kurumEvrakTarihSayisi"/>
        </div>
