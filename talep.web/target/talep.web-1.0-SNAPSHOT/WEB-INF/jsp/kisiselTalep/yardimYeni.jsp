<%-- 
    Document   : yardimYeni
    Created on : 29.Şub.2012, 03:19:07
    Author     : caner
--%>
...
<script type="text/javascript" src="static/js/kisiselTalep/yardimEdit.js"></script>
<link rel="stylesheet" type="text/css" href="static/css/kisiselTalep/generalForms.css"/>

<input class="yardimDivHeight" name="yardimDivHeight" value="${yardimDivHeight}"/>
<p class="general_form_headers">YARDIM TALEBI</p>

<form:form id="talepYardimYeni" modelAttribute="editYapilanIslem"  method="POST" action="yardimEdit/talepEklendi/yeni">
    ...
    <div class="yardimEdit_talep_sahibi_div talep_sahibi_div aristo_light_background">
        ...
        <div class="talep_sahibi_adres kayit_text">
            Adres :  <form:input type="text" class="talep_sahibi_adres_input" path="genelTalep.talepSahibi.gorevi"/>
        </div>


        <div class="yardimEdit_talep_sahibi_not_div talep_sahibi_not_div kayit_text">
