<%-- 
    Document   : genelTalep
    Created on : 12.Şub.2012, 02:23:34
    Author     : caner
--%>
...
<script type="text/javascript" src="static/js/kisiselTalep/genelTalepEdit.js"></script>
<link rel="stylesheet" type="text/css" href="static/css/kisiselTalep/generalForms.css"/>


<p class="general_form_headers">genelTalep TALEPLER</p>
<form:form id="talepGenelTalepEdit" modelAttribute="editYapilanIslem"  method="POST" action="genelTalep/talepEklendi/edit">
