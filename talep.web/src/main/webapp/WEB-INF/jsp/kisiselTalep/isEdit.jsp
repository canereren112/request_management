<%-- 
    Document   : isTalebiEdit
    Created on : 27.Oca.2012, 19:52:22
    Author     : caner
--%>
...
<form:form id="talepIsEdit" modelAttribute="editYapilanIslem"  method="POST" action="isEdit/talepEklendi/edit">
