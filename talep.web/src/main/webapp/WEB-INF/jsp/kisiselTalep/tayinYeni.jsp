<%-- 
    Document   : tayinYeni
    Created on : 25.Şub.2012, 02:55:38
    Author     : caner
--%>
...
<script type="text/javascript" src="static/js/kisiselTalep/tayinEdit.js"></script>
<link rel="stylesheet" type="text/css" href="static/css/kisiselTalep/generalForms.css"/>

<input class="tayinDivHeight" name="tayinDivHeight" value="${tayinDivHeight}"/>
<p class="general_form_headers">TAYIN TALEBI</p>

<form:form id="talepTayinYeni" modelAttribute="editYapilanIslem"  method="POST" action="tayinEdit/talepEklendi/yeni">
