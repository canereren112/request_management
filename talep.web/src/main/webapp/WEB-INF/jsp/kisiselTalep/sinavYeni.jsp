<%-- 
    Document   : sinavYeni
    Created on : 29.Şub.2012, 03:19:43
    Author     : caner
--%>
...
<script type="text/javascript" src="static/js/kisiselTalep/sinavEdit.js"></script>
<link rel="stylesheet" type="text/css" href="static/css/kisiselTalep/generalForms.css"/>

<input class="sinavDivHeight" name="sinavDivHeight" value="${sinavDivHeight}"/>
<p class="general_form_headers">SINAV TALEBI</p>

<form:form id="talepSinavYeni" modelAttribute="editYapilanIslem"  method="POST" action="sinavEdit/talepEklendi/yeni">
