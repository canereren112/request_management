<%-- 
    Document   : ogrenciYeni
    Created on : 29.Şub.2012, 03:20:10
    Author     : caner
--%>
...
<input class="ogrenciDivHeight" name="ogrenciDivHeight" value="${ogrenciDivHeight}"/>
<p class="general_form_headers">OGRENCI TALEBI</p>

<form:form id="talepOgrenciYeni" modelAttribute="editYapilanIslem"  method="POST" action="ogrenciEdit/talepEklendi/yeni">
